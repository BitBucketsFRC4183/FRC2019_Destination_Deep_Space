...
public class AutonomousConstants {
    public static final double CAMERA_FPS = 0; // TODO: actual

    public static final double OFF_AXIS_KP = 0;//3.5 (simulator);
    ...
    public static final double MIN_PARALLAX_DISTANCE = 1.5; // (simulator)
